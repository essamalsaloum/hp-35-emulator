...
export const physicsConstantDefs = {
  ...
  [K.MOLAR_VOLUME_OF_IDEAL_GAS]: {
    ...
    wikipedia: 'https://en.wikipedia.org/wiki/Molar_volume'
  },
  [K.AVOGADRO_CONSTANT]: {
    symb: 'N<sub>A</sub>',
  ...
  [K.RYDBERG_CONSTANT]: {
    ...
    value: '10973731.5685',
    unit: 'm<sup>-1</sup>',
    wikipedia: 'https://en.wikipedia.org/wiki/Rydberg_constant'
  },
  [K.ELEMENTARY_CHARGE]: {
    symb: 'e',
    ...
    unit: 'C',
    wikipedia: 'https://en.wikipedia.org/wiki/Elementary_charge'
  },
  [K.ELECTRON_MASS]: {
    symb: 'm<sub>e</sub>',
    text: 'Electron mass',
    ...
    unit: 'kg',
    wikipedia: 'https://en.wikipedia.org/wiki/Electron_rest_mass'
  },
  [K.PROTON_MASS]: {
    symb: 'm<sub>p</sub>',
    text: 'Proton mass',
  ...
  [K.MAGNETIC_FLUX_QUANTUM]: {
    ...
    unit: 'Wb',
    wikipedia: 'https://en.wikipedia.org/wiki/Magnetic_flux_quantum'
  },
  [K.BOHR_RADIUS]: {
    symb: 'a<sub>0</sub>',
    text: 'Bohr radius',
    ...
    unit: 'm',
    wikipedia: 'https://en.wikipedia.org/wiki/Bohr_radius'
  },
  [K.ELECTRIC_CONSTANT]: {
    symb: 'ε<sub>0</sub>',
    ...
    unit: 'F m<sup>-1</sup>',
    wikipedia: 'https://en.wikipedia.org/wiki/Vacuum_permittivity'
  },
  ...
  [K.FARADAY_CONSTANT]: {
    ...
    wikipedia: 'https://en.wikipedia.org/wiki/Faraday_constant'
  },
  [K.ATOMIC_MASS_CONSTANT]: {
    ...
    unit: 'kg',
    wikipedia: 'https://en.wikipedia.org/wiki/Atomic_mass_constant'
  },
  [K.MAGNETIC_CONSTANT]: {
    symb: 'μ<sub>0</sub>',
  ...
  [K.BOHR_MAGNETON]: {
    ...
    unit: 'J T<sup>-1</sup>',
    wikipedia: 'https://en.wikipedia.org/wiki/Bohr_magneton'
  },
  [K.NUCLEAR_MAGNETON]: {
    symb: 'μ<sub>N</sub>',
    ...
    unit: 'J T<sup>-1</sup>',
    wikipedia: 'https://en.wikipedia.org/wiki/Nuclear_magneton'
  },
  [K.PROTON_MAGNETIC_MOMENT]: {
    ...
    unit: 'J T<sup>-1</sup>',
    wikipedia: 'https://en.wikipedia.org/wiki/Proton_magnetic_moment'
  },
  [K.ELECTRON_MAGNETIC_MOMENT]: {
    ...
    unit: 'J T<sup>-1</sup>',
    wikipedia: 'https://en.wikipedia.org/wiki/Electron_magnetic_moment'
  },
  [K.NEUTRON_MAGNETIC_MOMENT]: {
    ...
    value: '-9.662364e-27',
    unit: 'J T<sup>-1</sup>',
    wikipedia: 'https://en.wikipedia.org/wiki/Neutron_magnetic_moment'
  },
  [K.MUON_MAGNETIC_MOMENT]: {
    ...
    unit: 'J T<sup>-1</sup>',
    wikipedia: 'https://en.wikipedia.org/wiki/Magnetic_moment'
  },
  [K.CLASSICAL_ELECTRON_RADIUS]: {
    ...
    unit: 'm',
    wikipedia: 'https://en.wikipedia.org/wiki/Classical_electron_radius'
  },
  ...
  [K.COMPTON_WAVELENGTH]: {
    ...
    unit: 'm',
    wikipedia: 'https://en.wikipedia.org/wiki/Compton_wavelength'
  },
  ...
  [K.STEFAN_BOLTZMAN_CONSTANT]: {
    ...
    wikipedia: 'https://en.wikipedia.org/wiki/Stefan%E2%80%93Boltzmann_constant'
  },
  ...
  [K.STANDARD_ATMOSPHERE]: {
    ...
    value: '101325',
    unit: 'Pa',
    wikipedia: 'https://en.wikipedia.org/wiki/Atmosphere_(unit)'
  },
  [K.PROTON_GYROMAGNETIC_RATIO]: {
    ...
    wikipedia: 'https://en.wikipedia.org/wiki/Proton_magnetic_moment#Proton_g-factor_and_gyromagnetic_ratio'
  },
  [K.FIRST_RADIATION_CONSTANT]: {
    ...
    unit: 'W m<sup>2</sup>',
    wikipedia: 'https://en.wikipedia.org/wiki/Planck%27s_law#First_and_second_radiation_constants'
  },
  ...
  [K.CONDUCTANCE_QUANTUM]: {
    ...
    unit: 'S',
    wikipedia: 'https://en.wikipedia.org/wiki/Conductance_quantum'
  },
  [K.NATURAL_LOGARITHM_BASE_NUMBER]: {
    ...
    value: '2.71828182846',
    unit: '',
    wikipedia: 'https://en.wikipedia.org/wiki/Natural_logarithm'
  }
}
